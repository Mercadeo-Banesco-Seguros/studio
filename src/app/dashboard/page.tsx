            ...
            <SectionWrapper>
                <div className="grid lg:grid-cols-2 gap-6">
                    <Card className="bg-primary text-primary-foreground p-6 flex flex-col justify-center rounded-2xl">
                        <Badge variant="secondary" className="bg-white/20 backdrop-blur-sm text-white font-light w-fit">Actívate</Badge>
                        <h2 className="text-4xl font-bold tracking-tight mt-4">¡Aprende algo nuevo cada día!</h2>
                        <Button asChild variant="secondary" className="bg-white/90 text-primary hover:bg-white rounded-full font-light mt-6 w-fit">
