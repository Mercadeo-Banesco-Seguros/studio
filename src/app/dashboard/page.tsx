...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const todayDate = new Date();
    const dayName = todayDate.toLocale_string('es-ES', { weekday: 'long' });
    const capitalizedDayName = dayName.charAt(0).toUpperCase() + dayName.slice(1);
    const todayDressCode = dressCodeItems.find(item => item.day === capitalizedDayName);
    setCurrentDressCode(todayDressCode || dressCodeItems[0]);
  ...
  const todaysMenus = useMemo(() => {
    const dayName = new Date().toLocale_string('es-ES', { weekday: 'long' });
        ...
        <section id="conectados" className="container mx-auto px-4 sm:px-6 lg:px-8 mt-24">
            <div className="relative bg-primary rounded-2xl shadow-lg text-white p-8 md:p-12 min-h-[300px] flex items-center overflow-hidden">
                ...
                <div className="absolute top-0 right-0 h-full w-1/2">
                    ...
                    <div className="absolute right-20 bottom-0 w-[350px] h-[450px]">
                ...
                <div className="relative z-10 w-full">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold max-w-md">¿Ya sabes cuántos ConectCoins tienes?</h2>
