            ...
            <SectionWrapper>
                <div className="grid lg:grid-cols-2 gap-6">
                    <div className="flex flex-col justify-center p-6">
                        ...
                        <h2 className="text-4xl font-bold tracking-tight text-foreground mt-4">¡Aprende algo nuevo cada día!</h2>
                        <Button asChild variant="default" className="rounded-full font-light mt-6 w-fit">
