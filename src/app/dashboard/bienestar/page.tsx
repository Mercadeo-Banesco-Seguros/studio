        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-12">
           ...
           <div className="relative h-[22rem] w-full flex items-center justify-center group">
              <Card className="absolute w-72 h-48 rounded-2xl overflow-hidden shadow-2xl transform transition-transform duration-500 ease-in-out -rotate-15 group-hover:rotate-0 group-hover:scale-90">
