          ...
          <div>
           ...
           <div className="relative h-[32rem] w-full rounded-2xl overflow-hidden group">
              <Image
                  ...
                  className="transition-transform duration-500 ease-in-out group-hover:scale-105 scale-130"
              />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-12">
           ...
           <div className="relative h-[22rem] w-full flex items-center justify-center group">
              <Card className="absolute w-72 h-48 rounded-2xl overflow-hidden shadow-2xl transform -rotate-15 -translate-x-48 group-hover:rotate-0 group-hover:translate-x-0 group-hover:scale-90 transition-transform duration-500 ease-in-out">
