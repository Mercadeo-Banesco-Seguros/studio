      ...
      <section className="py-12 sm:py-16 text-primary-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="relative h-[22rem] w-full flex items-center justify-center group">
            <Card className="absolute w-48 h-72 rounded-2xl overflow-hidden shadow-2xl transform transition-transform duration-500 ease-in-out rotate-[-15deg] group-hover:rotate-0 group-hover:translate-x-0">
