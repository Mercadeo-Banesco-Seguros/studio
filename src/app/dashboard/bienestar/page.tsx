    ...
    useEffect(() => {
        if (allEvents.length > 0) {
            ...
            const formattedEvents = specialEventsThisMonth.slice(0, 2).map(event => ({
                ...
                imageUrl: "https://images.unsplash.com/photo-1729155408920-20029e946e183?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxNHx8cmVzdHxlbnwwfHx8fDE3NTc2MTQ5MTN8MA&ixlib=rb-4.1.0&q=80&w=1080",
      ...
      <section className="py-12 sm:py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="relative h-[30rem] w-full flex items-center justify-center group">
            <Card className="absolute w-56 h-80 rounded-2xl overflow-hidden shadow-2xl transform transition-transform duration-500 ease-in-out group-hover:rotate-12 group-hover:translate-x-40 rotate-0 translate-x-0">
