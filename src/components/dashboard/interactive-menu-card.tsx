...
export const InteractiveMenuCard = ({ item }: InteractiveMenuCardProps) => {
  ...
  return (
    <div
      className={cn(
        "group/card relative p-6 rounded-2xl overflow-hidden transition-all duration-500 ease-in-out bg-card shadow-lg flex-1",
        "hover:flex-grow-[1.5]"
      )}
    >
      ...
      {/* Content for collapsed/default state */}
