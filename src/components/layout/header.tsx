...
import { Home, CalendarDays, FileText, Library, Menu, Search, Bell, Clock, Target, User, LogOut, GraduationCap, CheckCircle } from "lucide-react"; 
...
const navItemsDesktop = [
  ...
  { name: "Bienestar", href: "/dashboard/bienestar", icon: CheckCircle, activePaths: ["/dashboard/bienestar", "/dashboard/actividades"] },
