...
export const mockDepartments: Department[] = [
  {
    ...
    requests: [
      ...
      { title: "Solicitud de Carnet y Tarjeta Todoticket", type: 'request', icon: CreditCard, link: "https://docs.google.com/forms/d/e/1FAIpQLSfVKlghvjoQ-QRoK2qRZST4hhw8rMmj72-UND5dN7OXTT4POA/viewform" },
      ...
      { title: "Postúlate", type: 'request', icon: Briefcase, link: "https://www.linkedin.com/company/banesco-seguros/?originalSubdomain=ve" },
  ...
  },
  {
    ...
    icon: Megaphone,
    requests: [
        { title: "Solicitudes de Comunicaciones y Mercadeo BSV", type: 'request', icon: Megaphone, link: "https://docs.google.com/forms/d/e/1FAIpQLSd155PWPqbsS3NrBcXuvUm6oYnRlsx_NAfh_sV97SEAGUNx9w/viewform" },
    ]
  },
  {
    id: "pmo",
  ...
  },
  {
    ...
    icon: FileText,
    requests: [
      { title: "Portal de Solicitudes de Inteligencia y Desarrollo Comercial", type: 'request', icon: FileSignature, link: "https://docs.google.com/forms/d/e/1FAIpQLSdTEwWNzyiOE6GUsM4xkZnumDJ673-w8atYEBw6o3oH4lVRFA/viewform" },
    ]
  },
  {
  ...
  },
  {
    ...
    category: "Actuarial",
    icon: FileBarChart,
    directLink: "https://sites.google.com/banescoseguros.com/site-actuarial?usp=sharing",
  },
];
...
export const mockDocuments: DocumentResource[] = [
  ...
  { 
    ...
    imageUrl: "https://github.com/Rduque2025/web-assets-banesco-seguros/blob/main/image-Photoroom%20(42).png?raw=true",
  ...
  { 
    ...
    imageUrl: "https://github.com/Rduque2025/web-assets-banesco-seguros/blob/main/Gemini_Generated_Image_wfg3p2wfg3p2wfg3-Photoroom.png?raw=true",
...
export const mockExecutiveMenuItems: MenuItem[] = [
    { 
        id: "EM001", day: "Lunes", name: "Arroz con pollo y vegetales", 
        description: "Jugo de frutas, panquecas y pollo guisado, con infusión de tomates, sopa de res, y mandarinas de postre", 
        imageUrl: "https://github.com/Rduque2025/web-assets-banesco-seguros/blob/main/image-Photoroom.png?raw=true", 
        price: "$13", type: "Ejecutivo", dataAiHint: "peruvian steak" 
    },
    { 
        id: "EM002", day: "Martes", name: "Risotto de Champiñones y Trufa", 
        description: "Cremoso risotto Arborio con variedad de champiñones frescos y un toque de aceite de trufa.", 
        imageUrl: "https://github.com/Rduque2025/web-assets-banesco-seguros/blob/main/image-Photoroom%20(3).png?raw=true", 
        price: "$13", type: "Ejecutivo", dataAiHint: "mushroom risotto" 
    },
    { 
        id: "EM003", day: "Miércoles", name: "Paella de Mariscos Individual", 
        description: "Arroz bomba cocinado en caldo de pescado con camarones, calamares, mejillones y almejas.", 
        imageUrl: "https://github.com/Rduque2025/web-assets-banesco-seguros/blob/main/image-Photoroom%20(4).png?raw=true", 
        price: "$13", type: "Ejecutivo", dataAiHint: "seafood paella" 
    },
    { 
        ...
        imageUrl: "https://github.com/Rduque2025/web-assets-banesco-seguros/blob/main/image-Photoroom%20(1).png?raw=true", 
        price: "$13", type: "Ejecutivo", dataAiHint: "grilled steak" 
    },
    { 
        id: "EM005", day: "Viernes", name: "Canelones de Ricota y Espinaca", 
        description: "Canelones rellenos de suave ricota y espinacas frescas, bañados en salsa bechamel y gratinados.", 
        imageUrl: "https://github.com/Rduque2025/web-assets-banesco-seguros/blob/main/image-Photoroom%20(5).png?raw=true", 
        price: "$13", type: "Ejecutivo", dataAiHint: "cannelloni pasta" 
    },
];
...
export const mockDressCodeItemsCaballeros: DressCodeItem[] = [
  ...
  },
  {
    id: "DCC005",
    title: "Corporativo",
    description: "Estilo profesional y pulcro para cerrar la semana. Se recomienda un atuendo de negocios casual.",
...
export const mockDressCodeItemsDamas: DressCodeItem[] = [
  ...
  },
  {
    id: "DCD005",
    title: "Corporativo",
    description: "Un estilo profesional y pulcro para el cierre de la semana, combinando comodidad y elegancia.",
